...
* UnigramPlus тепер протестовано з NVDA 2026.2, і він використовує сучасні API діалогів NVDA із запасними варіантами для старіших версій NVDA.
* Видалено тимчасове виправлення назви тем «Збережених повідомлень» після того, як Unigram 12.10.1 додав коректні доступні імена рядкам чатів «Збережених повідомлень».
* Оновлено всі переклади й посібники для версії 5.6.9.
