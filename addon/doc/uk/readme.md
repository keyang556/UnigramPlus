...
> `Unigram (не задокументовано)` позначає сполучення клавіш, реалізовані в поточному вихідному коді Unigram, але ще не вказані в офіційному файлі Shortcuts.md.
...
| Сполучення клавіш | Категорія | Дія |
|---|---|---|
| **Ctrl+Tab / Alt+Arrow Up / Ctrl+Page Up** | Unigram | Next chat |
| **Ctrl+Shift+Tab / Alt+Arrow Down / Ctrl+Page Down** | Unigram | Previous chat |
| **Ctrl+Alt+Home** | Unigram (не задокументовано) | Перший чат |
| **Ctrl+Alt+End** | Unigram (не задокументовано) | Останній чат |
| **Ctrl+Alt+Up/Down** | UnigramPlus | Перейти до наступного або попереднього чату з непрочитаними згадками |
| **ALT+1** | UnigramPlus | Перенести фокус в список чатів |
| **ALT+2** | UnigramPlus | Перенести фокус на останнє повідомлення в чаті |
| **ALT+3** | UnigramPlus | Перенести фокус на мітку "непрочитані повідомлення" |
| **ALT+4** | UnigramPlus | Перенести фокус до списку папок чатів |
| **ALT+5** | UnigramPlus | Перемістити фокус до відкритого профілю |
| **ALT+6** | UnigramPlus | Перемістити фокус до списку гілок групи |
| **ALT+D** | UnigramPlus | Перенести фокус в поле введення повідомлення. Якщо фокус вже знаходиться в цьому полі, при натисканні він повернеться на останній елемент який був у фокусі |
...
| **Ctrl+Shift+F** | Unigram (не задокументовано) | Chat search |
| **Search key** | Unigram (не задокументовано) | Шукати на поточній сторінці |
| **ALT+I** | UnigramPlus | Перейти до списку з результатами пошуку в чаті |
| **F3** | UnigramPlus | Перейти до наступного результату пошуку |
| **Shift+F3** | UnigramPlus | Перейти до попереднього результату пошуку в чаті |

### Виділений текст у полі введення

| Сполучення клавіш | Категорія | Дія |
|---|---|---|
| **Ctrl+Z** | Unigram | Undo |
| **Ctrl+Y** | Unigram | Redo |
| **Ctrl+Shift+Z** | Unigram (не задокументовано) | Повторити |
| **Alt+X** | Unigram (не задокументовано) | Перетворити чотири виділені шістнадцяткові цифри на відповідний символ |
| **Ctrl+X** | Unigram | Cut |
| **Ctrl+C** | Unigram | Copy |
| **Ctrl+V** | Unigram | Paste |
| **Ctrl+A** | Unigram | Select All |
| **Ctrl+Shift+.** | Unigram | Цитата |
| **Ctrl+B** | Unigram | Bold |
| **Ctrl+I** | Unigram | Italic |
| **Ctrl+U** | Unigram | Підкреслення |
| **Ctrl+Shift+X** | Unigram | Strikethrough |
| **Ctrl+Shift+M** | Unigram | Monospace |
| **Ctrl+Shift+P** | Unigram | Spoiler |
| **Ctrl+K** | Unigram | Create Link |
| **Ctrl+Shift+N** | Unigram | Видалити форматування (звичайний текст) |
...
| **Ctrl+Shift+Down** | Unigram (не задокументовано) | Наступна папка |
| **Ctrl+Shift+Up** | Unigram (не задокументовано) | Попередня папка |
...
| **Ctrl+C** | UnigramPlus | Скопіювати повідомлення, якщо воно містить текст. Якщо фокус знаходиться на посиланні, буде скопійовано текст посилання |
| **ALT+Q** | UnigramPlus | Натиснути кнопку "Миттєвий перегляд", якщо така міститься в поточному повідомленні |
| **ALT+Delete** | UnigramPlus | Видалити повідомлення або чат |
| **Shift+Delete** | UnigramPlus | Видалити повідомлення або чат в для обох співрозмовників |
| **Delete** | Unigram (не задокументовано) | Видалити вибране або сфокусоване повідомлення |
| **Ctrl+ALT+C** | UnigramPlus | Відкрити коментарі |
| **Enter** | UnigramPlus | Відповісти на повідомлення |
| **ALT+F** | UnigramPlus | Переслати повідомлення |
| **Backspace** | UnigramPlus | Редагувати повідомлення |
| **ALT+Shift+R** | UnigramPlus | Позначити чат як прочитаний |
| **Ctrl+Space** | UnigramPlus | Перейти у режим вибору |
| **Unassigned** | UnigramPlus | Зберегти файл як... |
| **Unassigned** | UnigramPlus | Прикріпити повідомлення або чат |
| **Left Arrow** | UnigramPlus | Озвучити те повідомлення, у відповідь на яке було надіслано поточне повідомлення |
...
| **Ctrl+Shift+E** | Unigram (не задокументовано) | Відкрити засіб вибору емодзі |
| **Ctrl+Shift+G** | Unigram (не задокументовано) | Відкрити засіб вибору GIF |
| **Ctrl+Shift+S** | Unigram (не задокументовано) | Відкрити засіб вибору стікерів |
| **Ctrl+O** | Unigram (не задокументовано) | Відкрити діалог вибору файлів для надсилання документів |
...
### Голосові повідомлення та медіа

| Сполучення клавіш | Категорія | Дія |
|---|---|---|
| **ALT+P** | UnigramPlus | Відтворити/призупинити голосове повідомлення, яке зараз відтворюється |
| **ALT+S** | UnigramPlus | Пришвидшити/уповільнити швидкість відтворення голосового повідомлення |
| **ALT+E** | UnigramPlus | Закрити аудіопрогравач |
| **NVDA+ALT+R** | UnigramPlus | Перетворити голосове повідомлення на текст |
...
| **ALT+Shift+C** | UnigramPlus | Зателефонувати якщо це контакт, або увійти до голосового чату, якщо це група |
| **ALT+Shift+V** | UnigramPlus | Натиснути кнопку "Відео дзвінок" |
| **ALT+Y** | UnigramPlus | Відповісти на дзвінок |
| **ALT+N** | UnigramPlus | Натиснути кнопку "відхилити виклик" , Якщо є вхідний дзвінок, кнопку "завершити виклик" , якщо виклик виконується, або покинути голосовий чат, якщо він активний. |
| **ALT+A** | UnigramPlus | Натиснути кнопку "Увімкнути/вимкнути мікрофон" |
| **ALT+V** | UnigramPlus | Натиснути кнопку "Увімкнути/вимкнути камеру" |

### Інші сполучення клавіш
...
| **Ctrl+Shift+W** | Unigram (не задокументовано) | Зупинити відтворення медіа |
| **Ctrl+F4** | Unigram (не задокументовано) | Close current window |
| **Ctrl+L** | Unigram (не задокументовано) | Заблокувати Unigram |
| **Ctrl+M** | Unigram (не задокументовано) | Згорнути Unigram |
| **Ctrl+J** | Unigram (не задокументовано) | Відкрити завантаження |
| **ALT+T** | UnigramPlus | Повідомити назву та статус відкритого чату |
| **NVDA+Alt+V** | UnigramPlus | Відкрити відомості про версії Unigram і UnigramPlus у вікні лише для читання |
...
| **ALT+H** | UnigramPlus | Показати список усіх команд UnigramPlus |
| **ALT+U** | UnigramPlus | Змінити рівень озвучування індикаторів виконання |
| **ALT+Shift+L** | UnigramPlus | Скопіювати дані для проведення трансляції в буфер обміну |
| **NVDA+ALT+U** | UnigramPlus | Відкрити вікно налаштувань UnigramPlus |
<!-- shortcut-table-end -->
...
* Вилучено обхідний прийом для тривалості дзвінка. Unigram 12.10 і новіші самі озвучують тривалість у повідомленні про дзвінок, тож UnigramPlus більше її не додає і вона не звучить двічі.
* Виправлено збій запуску доповнення у старих версіях NVDA, у яких немає модуля utils.security.
* Вилучено імпорти, які доповнення більше не використовує.
* Оновлено в'єтнамський переклад.

### Версія 5.8.0

* Періодичні фонові перевірки доповнення більше не виконуються в головному циклі NVDA, тож навігація чатами, введення тексту й мовлення більше не затримуються, поки Unigram відповідає.
* Усі можливості, додані після версії 5.4, тепер можна увімкнути або вимкнути в налаштуваннях UnigramPlus; їх зібрано під одним заголовком: як озвучується кнопка запису голосового повідомлення, форматований текст повідомлення через ALT+C, підпис кнопки ідентифікації у профілі, озвучення відповіді та редагування в полі повідомлення, вимкнене озвучення "список" перед повідомленнями, поточний стан мікрофона й камери під час дзвінка, а також кількість непрочитаних при перемиканні папок чатів. Кожна з них типово зберігає поточну поведінку, а в кожному підписі зазначено, яку поведінку версії 5.4 вона повертає.
* Виправлено, що пробіл не відтворював голосові повідомлення, музику та файли.
* Виправлено, що Enter не відповідав на повідомлення, Backspace не відкривав його для редагування, ALT+C не показував його текст, а ALT+D не повертав до нього.
* Виправлено, що ALT+E не закривав аудіоплеєр.
* Виправлено, що Ctrl+ALT+Вліво та Ctrl+ALT+Вправо не перемотували відтворення голосового повідомлення, зокрема при повторному натисканні стрілки з утримуваними модифікаторами.
* Скасування запису голосового повідомлення озвучується приблизно через півтори секунди після зупинки, а не через п'ять секунд.
* Коли вибрано варіант кнопки запису з версії 5.4, фокус залишається в полі повідомлення на початку запису, а Tab, як і раніше, доходить до кнопки запису.
* Виправлено низку комбінацій клавіш, які мовчки не спрацьовували, коли в дереві Unigram бракувало очікуваного елемента: ALT+3, ALT+4, ALT+5, ALT+6, ALT+Q, ALT+T, ALT+Shift+L, ALT+Shift+P, Shift+Delete, навігація медіа та керування дзвінком.
* Перетворення голосового повідомлення на текст більше не запускає новий потік кожні пів секунди під час очікування і припиняє спроби замість нескінченного чекання.

### Версія 5.7.3

* NVDA+Alt+V тепер відображає версію UnigramPlus з нового рядка.

### Версія 5.7.2

* NVDA+Alt+V тепер відкриває відомості про версії в багаторядковому вікні лише для читання.

### Версія 5.7.1

* Виправлено помилкове розпізнавання кнопок реакцій у Unigram 12.10.2 як повідомлень, через яке сполучення для навігації повідомленнями замінювали їхню штатну дію перемикання.

### Версія 5.7.0

* Відновлено оголошення під час перемикання папок із ненульовою кількістю непрочитаних, із збереженням захистів відстежувача перебігу передавання файлів.
* Список сполучень клавіш оновлено за поточним вихідним кодом Unigram; позначено вбудовані сполучення, яких ще немає в офіційному Shortcuts.md.

### Версія 5.6.9

* Виправлено помилку, яка могла виникати, коли NVDA переходив на захищений робочий стіл, наприклад під час запиту UAC, за увімкненого фонового відстеження повідомлень UnigramPlus.
* Виправлено помилкове розпізнавання рядків тем Збережених повідомлень у Unigram 12.10.1+ як повідомлень лише через те, що їхні нативні підсумки містять час надсилання або отримання.
* Вилучено застарілий обхідний спосіб іменування тем Збережених повідомлень; поточні версії Unigram тепер нативно надають доступні імена для чатів Збережених повідомлень.
* Оновлено сумісність із NVDA 2026.2.
* Оновлено польський і бірманський переклади.

### Версія 5.6.8

* Виправлено збій Alt+C за встановленого WhatsApp Enhancer, спричинений конфліктом імен допоміжних модулів у appModules.
...
* Додано NVDA+Shift+V для повідомлення встановлених версій Unigram і UnigramPlus.
* Видалено тимчасове рішення для вбудованих кнопок Unigram 12.9 після виправлення їхніх міток у Unigram 12.9.1; це запобігає зависанням UIA у списках ботів, під час навігації повідомленнями й реакціями та у списку чатів.
* Оновлено всі переклади й посібники для версії 5.6.6.

### Версія 5.6.5

* Виправлено Enter для відповіді на повідомлення та Alt+Shift+R для позначення чатів як прочитаних у поточних версіях Unigram.
* Видалено режим веб-подання та його налаштування; тепер Alt+C завжди відкриває текст повідомлення в початковому спливному вікні wx.
* Оновлено всі переклади та посібники для версії 5.6.5.

### Версія 5.6.4

* Виправлено Shift+Delete: тепер використовується штатна команда Delete в Unigram і видалення для обох сторін підтверджується автоматично.
* Alt+2 тепер спочатку активує кнопку Unigram «Перейти вниз»; дубльоване сполучення Alt+End вилучено.
* Додано налаштування для вибору класичного вікна wx (типово) або веб-подання під час показу тексту повідомлення за допомогою Alt+C.
* Тепер використовується офіційний доступний текст форматованих повідомлень Unigram; додано тимчасове виправлення для непідписаних вбудованих кнопок в Unigram 12.9.
* Список сполучень клавіш оновлено за офіційною документацією Unigram 12.9.
* Додано тимчасове виправлення: рядки тем «Збережених повідомлень» тепер оголошують видиму назву чату замість назви типу TDLib.

### Версія 5.6.3

* Виправлено періодичну проблему, через яку NVDA промовляв «список» перед повідомленням під час навігації стрілками вгору та вниз.
* Додано налаштування для функції Alt+[, яка озвучує заголовки повідомлень після їхнього вмісту; типово її вимкнено.
* Додано необов’язкове звукове сповіщення про досягнення кінця чату.
...
* Виправлено відстеження прогресу передавання файлів: воно зупиняється на 100% і більше не створює новий потік під час кожного циклу опитування.
* Під час відкриття Unigram фокус тепер автоматично переміщується до списку чатів.
* Додано Ctrl+Alt+Up/Down для переходу чатами з непрочитаними згадками.
...
* Додано підтримку форматованих повідомлень. Вони озвучуються під час отримання фокуса та можуть бути відкриті за допомогою Alt+C у вікні перегляду.
* Посилання та змішаний вміст зберігаються, а посилання можна активувати з вікна перегляду.

### Версія 5.5.8

* Виправлено автоматичне оновлення: випуски тепер безпечно завантажуються з GitHub, а завантажений додаток перевіряється перед встановленням.

* Відновлено сумісність з Unigram 12.7, де перестали працювати кілька гарячих клавіш та оголошень.
* Повідомлення-опитування знову озвучують питання та варіанти відповіді.
* Список тем форуму знову озвучує попередній перегляд останнього повідомлення.
* Під час особистого дзвінка знову працюють гарячі клавіші вимкнення мікрофона (ALT+A), увімкнення або вимкнення камери (ALT+V) та завершення дзвінка (ALT+N).
* ALT+End знову переходить до останнього повідомлення в чаті.

### Версія 5.5.7

* Розділ сполучень клавіш упорядковано в таблиці за категоріями та об’єднано сполучення Unigram і UnigramPlus.
* Під час запису голосового або відеоповідомлення NVDA тепер озвучує "Запис голосового повідомлення" або "Запис відеоповідомлення" разом із минулим часом замість "Tn voice message".
