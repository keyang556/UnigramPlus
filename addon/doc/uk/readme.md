...
* Відновлено надійне виявлення запису голосових повідомлень і усунуто зайві перевірки UI Automation наприкінці чату, які могли сповільнювати навігацію повідомленнями; рядки вкладки «Збережені повідомлення» у профілі тепер зберігають нативні дані доступності Unigram і не спричиняють затримок через повний розбір дерева повідомлення.
