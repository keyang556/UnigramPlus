...
* Оновлено відстеження запису голосових повідомлень для поточної версії Unigram і вилучено постійне опитування UI Automation, яке могло сповільнювати навігацію чатами та повідомленнями.
