...
* Восстановлено надёжное обнаружение записи голосовых сообщений и исключены ненужные проверки UI Automation в конце чата, которые могли замедлять навигацию по сообщениям.
