...
* Восстановлено надёжное обнаружение записи голосовых сообщений и исключены ненужные проверки UI Automation в конце чата, которые могли замедлять навигацию по сообщениям; строки вкладки «Сохранённые сообщения» в профиле теперь сохраняют нативные данные доступности Unigram и не вызывают задержек из-за полного разбора дерева сообщения.
