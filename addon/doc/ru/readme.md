...
* Исправлена остановка звука набора через несколько секунд, когда собеседник ещё печатает; теперь звук продолжается, пока набор действительно не прекратится.
