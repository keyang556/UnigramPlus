...
* Обновлён мониторинг записи голосовых сообщений для текущей версии Unigram и удалён постоянный опрос UI Automation, который мог замедлять навигацию по чатам и сообщениям.
