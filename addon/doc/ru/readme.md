...
* UnigramPlus теперь протестирован с NVDA 2026.2 и использует современные API диалогов NVDA с резервными вариантами для более старых версий NVDA.
* Удалено временное исправление названия тем «Сохранённых сообщений» после того, как Unigram 12.10.1 добавил корректные доступные имена строкам чатов «Сохранённых сообщений».
* Обновлены все переводы и руководства для версии 5.6.9.
