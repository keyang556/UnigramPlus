...
* تشخیص مطمئن ضبط پیام صوتی بازیابی شد و از بررسی‌های غیرضروری UI Automation در انتهای گفتگو که می‌توانست پیمایش پیام‌ها را کند کند جلوگیری شد؛ ردیف‌های زبانهٔ پیام‌های ذخیره‌شده در نمایه نیز اکنون اطلاعات دسترس‌پذیری بومی Unigram را حفظ می‌کنند و دیگر با تجزیهٔ کامل درخت پیام باعث تأخیر نمی‌شوند.
