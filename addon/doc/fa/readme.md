...
* UnigramPlus اکنون با NVDA 2026.2 آزمایش شده است و از APIهای مدرن پنجره‌های گفتگوی NVDA، همراه با راه‌حل‌های جایگزین برای نسخه‌های قدیمی‌تر NVDA، استفاده می‌کند.
* پس از آنکه Unigram 12.10.1 نام‌های دسترس‌پذیر صحیحی به ردیف‌های گفتگوی پیام‌های ذخیره‌شده افزود، اصلاح موقت نام موضوع پیام‌های ذخیره‌شده حذف شد.
* همهٔ ترجمه‌ها و راهنماها برای نسخهٔ 5.6.9 به‌روز شدند.
