...
* تمت إزالة الحل البديل الخاص بمدة المكالمة. يعلن Unigram 12.10 وما بعده عن مدة رسالة المكالمة من تلقاء نفسه، لذلك لم تعد الإضافة تضيفها ولم تعد تُسمع مرتين.
* تم إصلاح فشل تشغيل الإضافة على إصدارات NVDA الأقدم التي لا توفر الوحدة utils.security.
* تمت إزالة عمليات الاستيراد التي لم تعد الإضافة تستخدمها.
* تم تحديث الترجمة الفيتنامية.

### الإصدار 5.8.0

* لم تعد عمليات الفحص الدورية في الخلفية تعمل ضمن الحلقة الرئيسية لـ NVDA، لذلك لم يعد التنقل في الدردشات والكتابة والنطق يتأخر بينما يستجيب Unigram.
* يمكن الآن تشغيل أو إيقاف كل سلوك أضيف بعد الإصدار 5.4 من إعدادات UnigramPlus، مجمّعة تحت عنوان واحد: كيفية الإعلان عن زر تسجيل الرسالة الصوتية، ونص الرسالة المنسق عبر ALT+C، وتسمية زر الهوية في الملف الشخصي، والإعلان عن الرد والتحرير في حقل الرسالة، وكتم الإعلان عن "قائمة" قبل الرسائل، والحالة الآنية للميكروفون والكاميرا أثناء المكالمة، وعدد غير المقروء عند تبديل مجلدات الدردشة. يحتفظ كل خيار بسلوكه الحالي افتراضيًا، ويوضح كل عنوان أي سلوك من الإصدار 5.4 يستعيده.
* تم إصلاح عدم تشغيل مفتاح المسافة للرسائل الصوتية والموسيقى والملفات.
* تم إصلاح عدم رد Enter على الرسالة، وعدم تحرير Backspace لها، وعدم إظهار ALT+C لنصها، وعدم عودة ALT+D إليها.
* تم إصلاح عدم إغلاق ALT+E لمشغل الصوت.
* تم إصلاح عدم تقديم أو تأخير تشغيل الرسالة الصوتية عبر Ctrl+ALT+يسار وCtrl+ALT+يمين، بما في ذلك عند الضغط على السهم مرة أخرى مع استمرار الضغط على مفاتيح التعديل.
* يتم الإعلان عن إلغاء التسجيل الصوتي بعد نحو ثانية ونصف من توقفه، بدلاً من خمس ثوانٍ.
* عند اختيار خيار زر التسجيل الخاص بالإصدار 5.4، يبقى التركيز في حقل الرسالة عند بدء التسجيل، بينما يظل Tab يصل إلى زر التسجيل.
* تم إصلاح مجموعة من الاختصارات التي كانت تفشل بصمت عندما يكون عنصر متوقع مفقودًا في شجرة Unigram: ALT+3 وALT+4 وALT+5 وALT+6 وALT+Q وALT+T وALT+Shift+L وALT+Shift+P وShift+Delete والتنقل في الوسائط وعناصر التحكم في المكالمة.
* لم يعد تحويل الرسالة الصوتية إلى نص يبدأ خيطًا جديدًا كل نصف ثانية أثناء الانتظار، ويتوقف بدلاً من الانتظار إلى ما لا نهاية.

### الإصدار 5.7.3

* يعرض NVDA+Alt+V الآن إصدار UnigramPlus في سطر جديد.
...
* أُصلحت مشكلة في Unigram 12.10.2 كانت تتسبب في التعامل مع أزرار التفاعل كرسائل، بحيث لم تعد اختصارات التنقل بين الرسائل تتجاوز إجراء التبديل الأصلي لها.
...
* تم إصلاح خطأ قد يحدث عند دخول NVDA إلى سطح مكتب آمن، مثل مطالبة التحكم بحساب المستخدم (UAC)، أثناء تمكين تتبع الرسائل في الخلفية في UnigramPlus.
* تم إصلاح تصنيف صفوف موضوعات الرسائل المحفوظة في Unigram 12.10.1+ كرسائل لمجرد أن ملخصاتها الأصلية تتضمن طابعًا زمنيًا للإرسال أو الاستلام.
* أُزيل الحل البديل القديم لاسم موضوع الرسائل المحفوظة؛ توفر إصدارات Unigram الحالية أسماء يمكن الوصول إليها لدردشات الرسائل المحفوظة بشكل أصلي.
* تم تحديث التوافق مع NVDA 2026.2.
* تم تحديث الترجمات البولندية والبورمية.

### الإصدار 5.6.8

* تم إصلاح فشل Alt+C عند تثبيت WhatsApp Enhancer بسبب تعارض اسم وحدة مساعدة في appModules.
...
* تم إصلاح Enter للرد على الرسائل و Alt+Shift+R لوضع علامة مقروء على الدردشات في إصدارات Unigram الحالية.
* تمت إزالة وضع عرض الويب وإعداده؛ يفتح Alt+C الآن دائمًا نص الرسالة في نافذة wx المنبثقة الأصلية.
* تم تحديث جميع الترجمات والأدلة للإصدار 5.6.5.
...
* تم إصلاح مشكلة متقطعة كان NVDA ينطق فيها "قائمة" قبل الرسالة أثناء التنقل بمفاتيح السهمين لأعلى ولأسفل.
* تمت إضافة إعداد لسلوك Alt+[ الذي ينطق رؤوس الرسائل بعد محتواها؛ وهو معطّل افتراضيًا.
* تمت إضافة إشعار صوتي اختياري عند الوصول إلى نهاية الدردشة.
...
* تم إصلاح تتبع تقدم نقل الملفات بحيث يتوقف عند 100% ولا ينشئ سلسلة تنفيذ جديدة في كل دورة تحقق.
* عند فتح Unigram، ينتقل التركيز الآن تلقائيًا إلى قائمة الدردشات.
* تمت إضافة Ctrl+Alt+Up/Down للتنقل بين الدردشات التي تحتوي على إشارات غير مقروءة.
