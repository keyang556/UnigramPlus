...
* أصبح UnigramPlus الآن مختبرًا مع NVDA 2026.2 ويستخدم واجهات برمجة مربعات الحوار الحديثة في NVDA، مع حلول احتياطية لإصدارات NVDA الأقدم.
* تمت إزالة الإصلاح المؤقت لاسم موضوعات الرسائل المحفوظة بعد أن أضاف Unigram 12.10.1 أسماء وصول صحيحة لصفوف دردشات الرسائل المحفوظة.
* تم تحديث جميع الترجمات والأدلة للإصدار 5.6.9.
