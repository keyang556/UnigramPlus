...
* Atualizado o monitoramento da gravação de mensagens de voz para o Unigram atual e removida a sondagem contínua da Automação da Interface do Usuário que poderia atrasar a navegação por conversas e mensagens.
