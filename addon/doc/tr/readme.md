...
* ALT+shift+P: Mevcut sohbetin profilini aç
...
* shift+F3: Sohbette önceki arama sonucuna git.
* F3: Sohbette bir sonraki arama sonucuna git.
* ALT+W: Bir mesajın gönderildiğini veya alındığını ve tepkilerin  sayısını    seslendirir . Çift tıklamak bu bilginin  seslendirme modunu değiştirir.
...
* Karşı taraf hâlâ yazarken yazma sesinin birkaç saniye sonra durması düzeltildi; artık yazma gerçekten durana kadar çalmaya devam ediyor.
