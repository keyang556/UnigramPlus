...
## Özel sesler
UnigramPlus sesleri eklentinin `appModules\media` klasöründe bulunur. NVDA Ayarları > UnigramPlus bölümünü açın ve **UnigramPlus sesler klasörünü aç** düğmesine basın. Bir sesi özelleştirmek için değiştirmek istediğiniz sesle aynı ada sahip WAV dosyanızı bu klasöre kopyalayın, ardından NVDA'yı yeniden başlatın veya eklentileri yeniden yükleyin. Eklenti güncellemeleri yerleşik sesleri geri getirebilir; özel dosyalarınızın bir kopyasını saklayın.
...
| **ALT+4** | UnigramPlus | Odağı klasör listesine taşı |
...
| **Ctrl+C** | UnigramPlus | Metin içeriyorsa, iletiyi kopyalayın. Odak bir bağlantı üzerindeyse, bağlantı kopyalanır |
...
| **Backspace** | UnigramPlus | Mesajı düzenle |
| **ALT+Shift+R** | UnigramPlus | Sohbeti okundu olarak işaretle |
| **Ctrl+Space** | UnigramPlus | Seçim moduna geç |
| **Unassigned** | UnigramPlus | Dosyayı farklı kaydet... |
| **Unassigned** | UnigramPlus | Mesajı veya sohbeti sabitle |
| **Left Arrow** | UnigramPlus | Yanıtlanan mesajı oku |
...
### Sesli mesajlar ve medya

| Kısayol | Kategori | İşlem |
|---|---|---|
| **ALT+P** | UnigramPlus | Şu anda çalınan sesli mesajı Oynat / Duraklat |
| **ALT+S** | UnigramPlus | Sesli mesaj çalma hızını hızlandırın/yavaşlatın |
| **ALT+E** | UnigramPlus | Ses oynatıcıyı kapat |
| **NVDA+ALT+R** | UnigramPlus | Sesli mesajı metne dönüştür |
...
| **ALT+Shift+C** | UnigramPlus | Özel bir sohbet ise arayın veya bir grup ise sesli sohbete giriş yapın |
| **ALT+Shift+V** | UnigramPlus | Görüntülü arama düğmesine tıklayın |
| **ALT+Y** | UnigramPlus | Aramayı Cevapla |
| **ALT+N** | UnigramPlus | Gelen bir çağrı geldiğinde "aramayı Reddet" düğmesine tıklayın arama devam ederse" aramayı Sonlandır " düğmesine tıklayın veya sesli sohbet etkinse Sesli sohbetten ayrılın. |
| **ALT+A** | UnigramPlus | Mikrofonu" "Aç/kapat düğmesine tıklayın |
| **ALT+V** | UnigramPlus | "Kamerayı etkinleştir / devre dışı bırak" düğmesine basın |
...
| **ALT+H** | UnigramPlus | Tüm UnigramPlus kısayollarının listesini göster |
| **ALT+U** | UnigramPlus | Aşama çubuğu bildirimlerini değiştir |
| **ALT+Shift+L** | UnigramPlus | Yayın yapmak için gerekli verileri panoya kopyala |
| **NVDA+ALT+U** | UnigramPlus | UnigramPlus ayarları penceresini aç |
<!-- shortcut-table-end -->
...
* Güvenilir sesli mesaj kaydı algılama geri getirildi ve mesajlarda gezinmeyi geciktirebilen gereksiz sohbet sonu UI Automation kontrolleri önlendi; profildeki Kaydedilmiş Mesajlar sekmesi satırları artık ileti ağacının tamamını çözümleyerek gecikmeye yol açmak yerine Unigram'ın yerel erişilebilirlik bilgilerini koruyor.
...
* Zengin ileti desteği eklendi. Zengin iletiler odaklandığında duyurulur ve Alt+C ile göz atılabilir bir pencerede açılabilir.
* Bağlantılar ve karma içerik korunur; bağlantılar göz atılabilir pencereden etkinleştirilebilir.

### Sürüm 5.5.8

* Otomatik güncellemeler düzeltildi: sürümler artık GitHub'dan güvenli bir şekilde alınıyor ve indirilen eklenti kurulumdan önce doğrulanıyor.

* Birkaç kısayolun ve duyurunun çalışmayı bıraktığı Unigram 12.7 ile uyumluluk geri getirildi.
* Anket iletileri soruyu ve yanıt seçeneklerini yeniden duyuruyor.
* Forum konuları listesi son iletinin önizlemesini yeniden duyuruyor.
* Bire bir çağrı sırasında mikrofonu sessize alma (ALT+A), kamerayı açma veya kapatma (ALT+V) ve çağrıyı sonlandırma (ALT+N) kısayolları yeniden çalışıyor.
* ALT+End yeniden sohbetteki en son iletiye gidiyor.

### Sürüm 5.5.7

* Klavye kısayolları bölümü kategorilere ayrılmış tablolar halinde yeniden düzenlendi ve Unigram ile UnigramPlus kısayolları birleştirildi.
...
* Ctrl+C artık iki kez işlenmiyor: odak bir bağlantıdayken bağlantıyı kopyalar, diğer durumlarda mesajı kopyalamayı Unigram'a bırakır.

### Sürüm 5.5.5

* Bir mesajı yanıtlama veya düzenleme artık her zamanki mesaj istemi yerine mesaj giriş alanında duyuruluyor.
* Yazma sesinin uygulama kapatıldıktan, karşı taraf yazmayı bıraktıktan veya sohbetten ayrıldıktan sonra bazen çalmaya devam etmesi düzeltildi; artık açık sohbette kimse yazmadığı anda duruyor.
* Birmanca yerelleştirme güncellendi.

### Sürüm 5.5.4

* Sohbet klasörlerindeki okunmamış sayaçları gibi istenmeyen duyurular düzeltildi; örneğin "Tümü 535". Dosya aktarım ilerlemesi artık yalnızca Unigram yükleme ve indirme denetimleriyle sınırlıdır ve Unigram pencereleri dışında yok sayılır.
* Telegram Desktop NVDA eklentisiyle birlikte çalışabilmesi için UnigramPlus yalnızca çalışan uygulama Unigram olarak algılandığında etkinleşecek şekilde düzeltildi.
* Aynı adları kullanan özel WAV dosyalarıyla sesleri değiştirmeyi kolaylaştırmak için UnigramPlus ayarlarına yerleşik sesler klasörünü açan bir düğme eklendi.
* Mesaj düzenleme alanında yukarı ok için odağı son odaklanılan mesaja taşıyan yeni bir seçenek eklendi.
* Geleneksel Çince zh_TW olarak yeniden oluşturuldu ve Basitleştirilmiş Çince zh_CN olarak eklendi.

### Sürüm 5.5.3

* Dosya yükleme ve indirme ilerlemesinin otomatik olarak duyurulması eklendi. İlerleme çubuğu duyuru ayarına "Yalnızca yükleme ve indirme sırasında" yeni seçeneği eklendi ve bu artık varsayılan ayardır. ALT+U kısayolu artık üç durum arasında geçiş yapar: kapalı, yalnızca yükleme/indirme sırasında ve tüm ilerleme çubuklarını duyur.
* Readme dosyası ve çeviriler güncellendi.

### Sürüm 5.5.2

* Readme dosyası ve çeviriler güncellendi.
* Yazma göstergesi sesi değiştirildi.

### Sürüm 5.5.1

* Grup konuları listesinde gezinmek için kullanılan kısayol (ALT+6) düzeltildi. Artık sohbet listesinden bir forum grubu açıldığında konu listesi doğru şekilde algılanıyor.
* Yazma göstergesi sesi eklendi: Karşı taraf sohbette yazarken bir ses döngü halinde çalar ve yazma durduğunda durur. Bu özellik, Unigram JAWS betiğindeki benzer özellikten esinlenmiştir.

### Sürüm 5.5.0

* NVDA 2026.1 ile uyumluluk eklendi.

### Sürüm 5.4.2

* NVDA 2025.3.3 ile uyumluluk eklendi.

### Sürüm 5.4.1

* NVDA 2025.1.2 ile uyumluluk eklendi.

### Sürüm 5.4.0

* Sohbet listesindeki bir sorun düzeltildi.

### Sürüm 5.3.0

* Bir mesajın gönderim veya alım zamanını ve mesajdaki tepkileri duyuran bir klavye kısayolu eklendi. Bu, bir mesajın tam metnini yeniden dinlemeden, gönderim veya alım zamanını duymak istediğinizde faydalıdır. Varsayılan olarak, bu ALT W tuş kombinasyonudur. Çift tıklama, bu bilginin duyurulma modunu değiştirir.
* Unigram arayüzündeki değişiklikler sonucunda son zamanlarda biriken tüm sorunlar  aradan kaldırıldı..
* Kullanıcı profilini açmak için kullanılan klavye kısayolu ALT shift P olarak değiştirildi.
* Çoğu uygulamada olduğu gibi, sonraki ve önceki arama sonuçlarına gitmek için klavye kısayolları F3 ve shift F3 olarak  deiştirildi..
* NVDA 2024.4 ile uyumluluk eklendi.

### Sürüm 5.2.5

* Eklentinin Unigram'ın en son sürümüyle uyumluluğu sağlandı.
