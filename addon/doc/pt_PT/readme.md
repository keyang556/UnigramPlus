...
* O UnigramPlus é agora testado com o NVDA 2026.2 e usa as API de diálogos modernas do NVDA, com alternativas para versões mais antigas do NVDA.
* Eliminada a correção temporária do nome dos tópicos das Mensagens guardadas depois de o Unigram 12.10.1 ter adicionado nomes acessíveis adequados às linhas de conversas das Mensagens guardadas.
